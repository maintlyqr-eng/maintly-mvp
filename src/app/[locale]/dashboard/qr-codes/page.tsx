...
export default function QrCodesPage() {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      // Facu (26 jul 2026, revisión de rendimiento): igual que en el
      // resto de estas páginas, el perfil propio no bloquea la carga
      // principal — van en paralelo, no en fila.
      await Promise.all([
        (async () => {
