...
export const config = {
  ...
  matcher: [
    ...
    "/dashboard/documents",
    "/(es|pt)/dashboard/documents",
    "/dashboard/customers",
    "/(es|pt)/dashboard/customers",
    "/dashboard/calendar",
    "/(es|pt)/dashboard/calendar",
    "/dashboard/qr-codes",
    "/(es|pt)/dashboard/qr-codes",
    "/dashboard/services",
    "/(es|pt)/dashboard/services",
    "/dashboard",
    "/(es|pt)/dashboard",
    "/dashboard/settings",
    "/(es|pt)/dashboard/settings",
    "/dashboard/assets",
    "/(es|pt)/dashboard/assets",
    "/dashboard/team-chat",
    "/(es|pt)/dashboard/team-chat",
    "/admin",
    "/(es|pt)/admin",
  ],
};
