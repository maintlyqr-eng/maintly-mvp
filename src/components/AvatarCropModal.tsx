    ...
    <div className="fixed inset-0 bg-black/60 z-[70] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-5">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-[14px] font-black text-zinc-900">Adjust your photo</h3>
        ...
        <div className="mt-4 flex items-center gap-3">
          <span className="text-[11px] text-zinc-400 font-bold shrink-0">Zoom</span>
          <input
        ...
        <p className="text-[11px] text-zinc-400 mt-2">Drag the photo to reposition it, use the slider to zoom.</p>
        ...
        <div className="flex gap-2 mt-5">
          ...
          >
            {saving ? "Saving…" : (<><Check size={14} /> Save photo</>)}
          </button>
        </div>
      </div>
    </div>
